...
Example
Given the array [âˆ’2,2,âˆ’3,4,âˆ’1,2,1,âˆ’5,3], the contiguous subarray [4,âˆ’1,2,1] has the largest sum = 6.
...
public class MaximumSubarray {
    ...
    public int maxSubArray1(int[] nums) {
        // write your code
        //æœ€å¤§å­�åº�åˆ—ä¸ºä¸¤ä¸ªå®šèµ·ç‚¹åº�åˆ—å·®å€¼çš„æœ€å¤§å€¼,
        //åŠ¨å½’: max= max(curent sum- min, max ); min=(min, sum),
        //åŠ¨å½’2: dp[i]=max(dp[i-1]+num[i], num[i]), max=max(max,dp[i]);
        if(nums.length==0||nums==null){
            return 0;
