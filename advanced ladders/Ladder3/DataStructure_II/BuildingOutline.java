 ...
 * (start, end, height)，where start is the start position on x-axis, 
...
Notice: Please merge the adjacent outlines if they have the same height and make sure 
different outlines cant overlap on x-axis.
